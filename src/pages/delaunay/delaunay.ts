...
/**
 * Generated class for the DelaunayPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-delaunay',
  templateUrl: 'delaunay.html',
})
export class DelaunayPage {

  EPSILON : any = 1.0 / 1048576.0;
  Delaunay : any;
  ...
  triangulate(vertices : any, key : any) {
...
ionViewDidLoad() {
  console.log('ionViewDidLoad DelaunayPage');
}
