...
/**
 * Generated class for the TriangulatorPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */

export class TriangulatorPage {
  ...
  /**
   * Get blank canvas and image in base64 format with relevent inforamtion size, threshold etc. in params variable
   * @param elem canvas
   * @param params object
   */
  triangulator(elem, params) {
        ...
        /**
         * Image building in blank canvas through jsfeat using denaulay algorithm
         */
        let scop = this;
        image.onload = function() {
            ...
            if (size) {
                if (width > height) {
                    ...
                    width = Math.floor((window.innerWidth*80)/100);
                    height = Math.floor(((window.innerHeight-110)*80)/100);
                } else {
                    // height = size;
            ...
            */
            ...
            var triangles = [];
            triangles = new DelaunayPage().triangulate(cornerArray);
